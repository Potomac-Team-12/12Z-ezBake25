...
void newskills(){
  ...
  chassis.pid_drive_set(-9, DRIVE_SPEED, true); //was 7
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(4.5, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(358, TURN_SPEED);
  pros::delay(100);
  chassis.pid_wait();
  ...
  chassis.pid_turn_set(324, TURN_SPEED);
  chassis.pid_wait();
