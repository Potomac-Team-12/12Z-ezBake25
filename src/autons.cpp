...
void blue_neg_rings(){ //one tile over, no wall stake
  ...
  chassis.pid_drive_set(14.75, DRIVE_SPEED, true); //first ring
  pros::delay(100);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(12.5, DRIVE_SPEED, true); //second ring
  pros::delay(100);
  chassis.pid_wait();
...
void newskills(){
  ...
  chassis.pid_drive_set(54, DRIVE_SPEED, true);
  pros::delay(100);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(-7.75, DRIVE_SPEED, true);
  pros::delay(100);
  chassis.pid_wait();
